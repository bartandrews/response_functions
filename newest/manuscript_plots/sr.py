...
def plot_2d_q(axis, name, numb_qy, omega_min, omega_max):
    ...
    for qy_value in qy_list:
        ...
        with open('/home/bart/PycharmProjects/response_functions/newest/FQHETorusSpectralResponse/stripped_files/' + file, 'r') as csvfile:
...
if __name__ == "__main__":
    ...
    plt.savefig("/home/bart/PycharmProjects/response_functions/newest/figures/new_code_reduced_precision.png", bbox_inches='tight', dpi=300)
    plt.show()
