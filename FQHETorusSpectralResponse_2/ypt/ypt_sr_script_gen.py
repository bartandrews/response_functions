...
if __name__ == "__main__":
    ...
    file.write("runs() {\n")
    for n_val in [8]:
        for lamb_exp in [0]:  # -3, -2, -1, 0, 1, 2
            lamb = 10 ** lamb_exp
            for trunc in range(2, 14, 2):
                if trunc != 100:
                    ...
                    dat_file = f"{response_functions}/vectors_2/ypt/n_{n_val:g}/l{lamb:g}/fermions_torus_kysym_coulomb_0_plus_YukawaPlaneL{lamb:g}_n_{n_val:g}_2s_{3 * n_val:g}_ratio_1.000000.dat"
                    ky_val = gs_ky_val(dat_file)

                    file.write(f"echo {SpectralResponse} {response_functions}/vectors_2/ypt/n_{n_val:g}/l{lamb:g}/fermions_torus_kysym_coulomb_0_plus_YukawaPlaneL{lamb:g}_n_{n_val:g}_2s_{3*n_val:g}_ratio_1.000000_ky_{ky_val:g}.0.vec --sr-omega-min -20 --sr-omega-max 0 --sr-epsilon 1E-4 --sr-omega-interval 1E-5 --sr-spectral-resolution 1E-5 --use-coulomb --coulomb-strength 0 --perturbation-file {response_functions}/pseudopotentials/plane/pseudopotentials_YukawaPlaneL{lamb:g}.dat --perturbation-strength 1 --nbr-perturbation {trunc:g} -y 0 -m 8000\n")
