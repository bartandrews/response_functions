...
find . -type f -name "*.sr" -not -path "*/coulomb_newest/*" -not -path "*/laughlin_newest/*" -not -path "*/coulomb_full_precision/*" -not -path "*/laughlin_full_precision/*" -print0 | while read -d $'\0' file
do
