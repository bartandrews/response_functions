...
find . -type f -name "*.sr" -not -path "*/coulomb_latest/*" -not -path "*/laughlin_latest/*" -not -path "*/coulomb_full_precision/*" -not -path "*/laughlin_full_precision/*" -print0 | while read -d $'\0' file
do
