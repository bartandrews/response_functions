...
def plot_2d_cpt_variable_full(axis, numb_qy, omega_min, omega_max):
    ...
    axis.legend(loc='upper right', handletextpad=0, borderpad=0.2, framealpha=1,
                ...
                fontsize=10, ncol=5, labelspacing=0, columnspacing=0, bbox_to_anchor=(1.01, 1.4), title='$\\alpha/10$')
...
def plot_3d_cpt_variable_full(axis, numb_qy, omega_min, omega_max):
    ...
    # fig.subplots_adjust(top=1, bottom=0, right=0.95, left=-0.45, hspace=0, wspace=0)
...
def plot_2d_cpt_variable_full_box(axis, numb_qy, omega_min, omega_max):
    ...
    axis.boxplot(data_to_plot, positions=lbl, flierprops=props, whiskerprops={"linewidth": 0.5}, boxprops={"linewidth": 0.5}, capprops={"linewidth": 0.5}, medianprops={"linewidth": 0.5}, widths=1)
...
if __name__ == "__main__":
    ...
    plt.savefig("/home/bart/Documents/papers/SR/cpt.png", bbox_inches='tight', dpi=300)
    plt.show()
