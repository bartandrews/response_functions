...
def plot_coulomb(axis, omega_min, omega_max, epsilon):
    ...
    omega = []
    SR = []
    file = f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0" \
...
def plot_2d_gap_omega_res_max(axis):
    ...
    for i, file in enumerate([f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-10--5_eps_0.0001.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-8.75--6.25_eps_5e-05.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-8.125--6.875_eps_2.5e-05.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-7.8125--7.1875_eps_1.25e-05.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-7.65625--7.34375_eps_6.25e-06.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-7.57812--7.42188_eps_3.125e-06.sr.cut",
                              f"fermions_torus_spec_resp_kysym_coulomb_n_8_2s_24_ratio_1.000000_qy_0.omega_-7.53906--7.46094_eps_1.5625e-06.sr.cut"]):
...
if __name__ == "__main__":
    ...
    plt.savefig("/home/bart/Documents/papers/SR/coulomb_scaling_n_8.png", bbox_inches='tight', dpi=300)
    plt.show()
