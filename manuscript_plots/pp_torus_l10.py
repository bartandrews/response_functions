...
if __name__ == "__main__":
    ...
    spec_directory = '/home/bart/PycharmProjects/response_functions/energy_spectra/n_2/pp_torus_l10'
    pp_file = 'pseudopotentials_YukawaPlaneL10.dat'
    ...
    for idx in idx_list:
        for flux in range(6, flux_limit+1, 2):
            ...
            spec_file = f'fermions_torus_YukawaPlaneL10_V{2*idx+1}_only_n_2_2s_{flux}_ratio_1.000000.dat'
    ...
    print(red_points)
    plt.savefig("/home/bart/Documents/papers/SR/pp_torus_l10.png", bbox_inches='tight', dpi=300)
    plt.show()
