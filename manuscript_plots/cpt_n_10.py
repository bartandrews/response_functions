...
def plot_2d_cpt_variable_full(axis, numb_qy, omega_min, omega_max):
    ...
    for i, name in enumerate(name_list):
        ...
        with open('/home/bart/PycharmProjects/response_functions/FQHETorusSpectralResponse/stripped_files/' + file, 'r') as csvfile:
            ...
            for row in plots:
                omega.append(float(row[0])+10-9.40424502)
...
def plot_2d_cpt_variable_full_box(axis, numb_qy, omega_min, omega_max):
    ...
    x = np.linspace(0, int(numb_qy/2), 256, endpoint = True)
...
if __name__ == "__main__":
    ...
    plot_2d_cpt_variable_full(ax0, 30, omega_min=-100, omega_max=100)
    ax1 = plt.subplot(gs[1], projection='3d')
    plot_3d_cpt_variable_full(ax1, 30, omega_min=-100, omega_max=100)
    ax2 = plt.subplot(gs[2])
    plot_2d_cpt_variable_full_box(ax2, 30, omega_min=-100, omega_max=100)
    ax3 = plt.subplot(gs[3])
    plot_2d_cpt_variable_full_hist(ax3, 30, omega_min=-100, omega_max=100)
    ...
    plt.savefig("/home/bart/Documents/papers/SR/cpt_n_10.png", bbox_inches='tight', dpi=300)
    plt.show()
